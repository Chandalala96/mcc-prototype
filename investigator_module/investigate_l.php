<?php
   include_once('investigator_header.php');
     ...
     $id = $_GET["id"];
            ...
            $login_logged_incidents = "SELECT * FROM failedlogin_logged_incidents WHERE id = '$id';";
            
            
  
 $result = @mysqli_query($conn, $login_logged_incidents);
