...
<html>
<head>
  <title>MCC Appliction Prototype</title>
...
<div class="sidenav text-center">
  ...
  <br>
  <a href="#clients"><i class="bi bi-key-fill"></i> Change Password</a>
</div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
     <!--  <ul class="navbar-nav">
      ...
      <button class="btn" type="submit" name="user_logout" id="button" onclick="myFunction()" style="background: black; color: white;">Log out</button>
    </form>
    </div>
  </div>
</nav>
